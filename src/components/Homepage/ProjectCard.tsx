...
export const ProjectCard = () => {
	return (
		<div
            ...
            hover:bg-background-light shadow-tile w-[456px] cursor-pointer
            rounded-sm transition-all duration-1000 hover:outline'
		>
			<div className='p-6'>
				<div className='flex justify-between'>
					<h2 className='text-lg font-semibold'>The Used Car Buyer Problem</h2>
					<Chip variant='active' className='dark:text-text-default!'>
						Open
					</Chip>
				</div>
				<p className='text-text-tertiary'>Decision analysis for used car purchases</p>
			</div>
